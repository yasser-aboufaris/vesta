  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-green-800">Exercise Statistics</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-green-600">Total Exercises</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-green-600">With Description</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-green-600">Avg. Description</p>
